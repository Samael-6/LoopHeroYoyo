...
# BP_Sentinelle
Si le joueur n'a pas l'épée en passant sur la case alors, un dialogue qui parle de s'équiper se déclanche. En cas contraire le joueur vainc la sentinelle et il est téléporté à la case du roi ce qui déclenche le dialogue de victoire.
